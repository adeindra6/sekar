                ...
                <ul class="product-list">
                  <li class="product-list-item">
                    <div class="item-info">
                      ...
                      <div class="item-name">
                        <div class="product-name">Green Kind</div>
                        <div class="text-second">Menu Diabetes</div>
                      </div>
                    </div>
                    <div class="item-sale-info">
                      <div class="text-second">Sales</div>
                      <div class="product-sales">560pcs</div>
                    </div>
                  </li>
                  <li class="product-list-item">
                    <div class="item-info">
                      <img src="" alt="product image" />
                      <div class="item-name">
                        <div class="product-name">Sisu Healthy</div>
                        <div class="text-second">Menu</div>
                      </div>
                    </div>
                    <div class="item-sale-info">
                      <div class="text-second">Sales</div>
                      <div class="product-sales">450pcs</div>
                    </div>
                  </li>
                  <li class="product-list-item">
                    <div class="item-info">
                      <img src="" alt="product image" />
                      <div class="item-name">
                        <div class="product-name">Healthy Food</div>
                        <div class="text-second">Menu</div>
                      </div>
                    </div>
                    <div class="item-sale-info">
                      <div class="text-second">Sales</div>
                      <div class="product-sales">500pcs</div>
                    </div>
                  </li>
                  <li class="product-list-item">
                    <div class="item-info">
                      <img src="" alt="product image" />
                      <div class="item-name">
                        <div class="product-name">Good Food</div>
                        <div class="text-second">Menu</div>
                      </div>
                    </div>
                    <div class="item-sale-info">
                      <div class="text-second">Sales</div>
                      <div class="product-sales">250pcs</div>
                    </div>
                  </li>
                </ul>
              </div>
