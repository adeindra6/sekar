    ...
    <div id="app">
      ...
      <section class="hero is-hero-bar">
        <div class="hero-body">
          <div class="level">
            <div class="level-left">
              <div class="level-item"><h1 class="title">Item</h1></div>
            </div>
      ...
      <section class="section is-main-section">
        <div class="card">
          ...
          <div class="card-content">
            <form action="tambah_data_item.php" method="POST">
              <div class="field">
                <label class="label" for="nama-item">Nama Item:</label>
                <div class="control">
                  <input class="input" type="text" id="nama-item" name="nama-item" required />
                </div>
              </div>
              <div class="field">
                <label class="label" for="jumlah-item">Jumlah Item:</label>
                <div class="control">
                  <input class="input" type="number" id="jumlah-item" name="jumlah-item" required />
                </div>
              </div>
              <div class="field">
                <label class="label" for="harga-item">Harga Item:</label>
                <div class="control">
                  <input class="input" type="number" id="harga-item" name="harga-item" required />
                </div>
              </div>
              <div class="field is-grouped">
                <div class="control">
                  <button type="submit" class="button is-primary" value="tambahitem" name="tambahitem" id="tambahitem">Tambah Item</button>
                </div>
                <div class="control">
