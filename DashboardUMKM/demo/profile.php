        ...
        <div class="navbar-item has-dropdown has-dropdown-with-icons has-divider has-user-avatar is-hoverable">
          <a class="navbar-link is-arrowless">
            <div class="is-user-avatar">
              <img src="<?php  echo 'http://localhost/sekar'.$_SESSION['foto_resto'];?>" alt="John Doe">
            </div>
          ...
          <div class="navbar-dropdown">
            <a href="profile.php" class="navbar-item is-active">
              <span class="icon"><i class="mdi mdi-account"></i></span>
              <span>My Profile</span>
            </a>
            <a class="navbar-item">
  ...
  <aside class="aside is-placed-left is-expanded">
    ...
    <div class="menu is-menu-main">
      ...
      <ul class="menu-list">
        ...
        <li>
          <a href="profile.php" class="is-active has-icon">
          ...
          <div class="card-content">
            ...
            <div class="field">
              ...
              <div class="control is-clearfix">
                <input type="text" readonly value="<?php  echo $_SESSION['nama']; ?>" class="input is-static">
              </div>
            </div>
            <hr>
            <div class="field">
              <label class="label">E-mail</label>
              <div class="control is-clearfix">
                <input type="text" readonly value="<?php  echo $_SESSION['email']; ?>" class="input is-static">
              </div>
            </div>
          </div>
        </div>
